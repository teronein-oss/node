...
import { ChevronDown, ChevronUp, Calendar, Trash2, RotateCcw, Plus, Pencil, Check, X } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">날짜·항목별 숙제 관리 및 제출 현황</p>
      </div>
                ...
                {isExpanded && (
                  <div className="px-5 pb-5 border-t border-slate-100">
                    ...
                    {items.length > 0 ? (
                              ...
                              {editingItemId === item.id ? (
                                <>
                                  <input
                                    ...
                                    onKeyDown={e => {
                                      if (e.key === 'Enter') handleSaveItemEdit(hw!, item.id)
                                  ...
                                  />
                                  <button onClick={() => handleSaveItemEdit(hw!, item.id)} className="p-1 text-blue-500 hover:text-blue-700 shrink-0">
                                    <Check size={14} />
                                  </button>
                                ...
                                <>
                                  ...
                                  <button
                                    onClick={() => handleRemoveItem(hw!, item.id)}
                      ...
                      <p className="text-xs text-slate-400 pt-4">항목을 추가해주세요</p>
                    )}
                      ...
                      <div className="flex justify-end mt-2">
                        {confirmClearSession === sessionNum ? (
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => { dispatch({ type: 'DELETE_HOMEWORK', payload: hw.id }); setConfirmClearSession(null) }}
